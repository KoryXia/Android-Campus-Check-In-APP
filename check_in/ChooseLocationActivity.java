...
import com.example.check_in.utils.SearchResultAdapter;
import com.example.check_in.utils.SegmentedGroup;
...
public class ChooseLocationActivity extends AppCompatActivity implements LocationSource, AMapLocationListener, GeocodeSearch.OnGeocodeSearchListener, PoiSearch.OnPoiSearchListener {
    ...
    private ChoosedPoint choosedPoint;
    ...
    private void initView() {
        ...
        searchResultAdapter = new SearchResultAdapter(ChooseLocationActivity.this);
    ...
    private void initGPS() {
        ...
        if(!locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER)){
            MaterialDialog.Builder builder = new MaterialDialog.Builder(ChooseLocationActivity.this);
...
//        Log.i("MY", "geoAddress"+ searchLatlonPoint.toString());
    ...
    protected void doSearchQuery() {
        ...
        if (searchLatlonPoint != null) {
            ...
            poiSearch.setBound(new PoiSearch.SearchBound(searchLatlonPoint, 5000, true));//
    ...
    private void updateListview(List<PoiItem> poiItems) {
        ...
        choosedPoint = new ChoosedPoint(firstItem.getLatLonPoint().getLatitude(),firstItem.getLatLonPoint().getLongitude(),firstItem.getTitle());
    ...
    AdapterView.OnItemClickListener onItemClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            if (position != searchResultAdapter.getSelectedPosition()) {
                ...
                searchResultAdapter.notifyDataSetChanged();
                choosedPoint = new ChoosedPoint(curLatlng.latitude,curLatlng.longitude,poiItem.getTitle());
            }
        }
    };
    ...
    public void confirm(View v){
        AddActivity.mLocationViewModel.getCurrentChoosedPoint().setValue(choosedPoint);
        finish();
    }
